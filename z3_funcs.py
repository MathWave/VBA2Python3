...
def NextBuy13(Buy03, Buy02, Buy01, Sell01, Sell02, Sell03, Buy13, Buy12, Buy11, Sell11, Sell12, Sell13, Operation, Price, Volume):
	return If(And(Operation == StringVal("Buy"), Price == 101), If(Buy12 != 0 or Buy02 != 0, Volume, 0), If(And(Operation == StringVal("Buy"), Price == 102), If(Volume < Sell01 + Sell02 + Sell03 + Sell11 + Sell12 + Sell13, Buy13, Buy12), If(And(Operation == StringVal("Sell"), Price == 101), If(Volume < Buy01 + Buy11, Buy13, 0), If(Buy01 == 0, Buy13, If(Volume < Buy01, Buy13, 0)))))
...
def IsPossible(Buy03, Buy02, Buy01, Sell01, Sell02, Sell03, Buy13, Buy12, Buy11, Sell11, Sell12, Sell13, Operation, Price, Volume):
	return If(And(Buy02 + Buy12 != 0, Operation == StringVal("Buy"), Price == 101 or Sell03 != 0, Operation == StringVal("Sell"), Price == 102), False, True)
