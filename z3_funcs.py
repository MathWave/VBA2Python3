...
def IsPossible(Buy03, Buy02, Buy01, Sell01, Sell02, Sell03, Buy13, Buy12, Buy11, Sell11, Sell12, Sell13, Operation, Price, Volume):
	return If(Or(And(Buy02 + Buy12 != 0, Operation == StringVal("Buy"), Price == 101), And(Sell03 != 0, Operation == StringVal("Sell"), Price == 102)), False, If(Or(Buy03 < 0, Buy02 < 0, Buy01 < 0, Sell01 < 0, Sell02 < 0, Sell03 < 0, Buy13 < 0, Buy12 < 0, Buy11 < 0, Sell11 < 0, Sell12 < 0, Sell13 < 0), False, If(Or(Operation == StringVal("Buy"), Operation == StringVal("Sell")), If(Or(Price == 101, Price == 102), True, False), False)))

def Symb(x):
	return If(x == 0, StringVal("0"), StringVal("M"))
